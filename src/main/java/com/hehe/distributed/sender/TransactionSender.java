package com.hehe.distributed.sender;

import com.hehe.distributed.annotation.TransMessage;
...
public class TransactionSender {
    ...
    @Pointcut("@annotation(com.hehe.distributed.annotation.TransMessage)")
